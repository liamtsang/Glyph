...
// URLS
import busturl from "../../public/static/abdur_rahman/coin/coin.glb?url";
...
let f2 = addText("Abdur Rahman", .75, -.85, 0, Math.PI, '#ffffff');
let f3 = addText("Kabul, Afghanistan", .75, -1.05, 0, Math.PI, '#ffffff');
let f4 = addText("1888 AD", .75, -1.25, 0, Math.PI, '#ffffff');
let f5 = addText("Silver", .75, -1.45, 0, Math.PI, '#ffffff');

let b1 = addText("", .75, -.65, 0, Math.PI, '#E71616');
let b2 = addText("↓ Translation", .75, -.85, 0, Math.PI, '#E71616');
let b3 = addText("Emir Abd", .75, -1.05, 0, Math.PI, '#ffffff');
let b4 = addText("al-Rahman", .75, -1.25, 0, Math.PI, '#ffffff');
let b5 = addText("1306 (1888 AD)", .75, -1.45, 0, Math.PI, '#ffffff');

let f6 = addText("↓ Translation", .75, 1.6, 0, Math.PI, '#E71616');
let f7 = addText("1306 (1888 AD)", .75, 1.4, 0, Math.PI, '#ffffff');
let f8 = addText("Struck in the", .75, 1.20, 0, Math.PI, '#ffffff');
let f9 = addText("Sultanat of Kabul", .75, 1, 0, Math.PI, '#ffffff');
...
const dl2 = directionalLight.clone();
dl2.position.set(-5, 5, -5);

scene.add(directionalLight,dl2);
