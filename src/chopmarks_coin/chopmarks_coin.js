...
// URLS
import busturl from "../../public/static/chopmarks/coin/chopmark_coin.glb?url";
...
let f2 = addText("Charles III", .75, -.85, 0, Math.PI, '#ffffff');
let f3 = addText("Peru & China", .75, -1.05, 0, Math.PI, '#ffffff');
let f4 = addText("1805 AD", .75, -1.25, 0, Math.PI, '#ffffff');
...
let b3 = addText("King of Spain", .75, -1.05, 0, Math.PI, '#ffffff');
let b4 = addText("and the Indies,", .75, -1.25, 0, Math.PI, '#ffffff');
let b5 = addText("Lima", .75, -1.45, 0, Math.PI, '#ffffff');

let f6 = addText("↓ Translation", .75, 1.6, 0, Math.PI, '#E71616');
let f7 = addText("Carlos III", .75, 1.4, 0, Math.PI, '#ffffff');
let f8 = addText("By the Grace ", .75, 1.20, 0, Math.PI, '#ffffff');
let f9 = addText("of God, 1805", .75, 1, 0, Math.PI, '#ffffff');
